...
export const StepContext = z.object({
  ...
  isEmployable: z
    .boolean()
    .describe(
      "Gibt an ob der Antragsteller erwärbsfähig ist. Ist die Person nicht erwärbsfähig, kann sie kein Grundsicherung beantragen. In dem Fall stehen ihr andere Förderungen zu."
    ),
  spendings: z.object({
